...
use humhub\modules\space\widgets\SpaceNameColorInputCommunity;
use yii\helpers\Url;
...
<?php ModalDialog::begin(['header' => Yii::t('SpaceModule.views_create_create', '<strong>Create</strong> new community'), 'size' => 'small']) ?>
<?php $form = ActiveForm::begin(['enableClientValidation' => false]); ?>
<div class="modal-body">

    <?= SpaceNameColorInputCommunity::widget(['form' => $form, 'model' => $model]) ?>

    <?= $form->field($model, 'description')->textarea(['placeholder' => Yii::t('SpaceModule.views_create_create', 'community description'), 'rows' => '3']); ?>
...
<div class="modal-footer">
    <?= ModalButton::submitModal(Url::to(['/space/create/create_community']), Yii::t('SpaceModule.views_create_create', 'Next')); ?>
</div>
<?php ActiveForm::end(); ?>
<?php ModalDialog::end(); ?>
