 ...
 */
class ChooserCustom extends Widget
{
    public $community;
    ...
    public function run()
    {
        ...
        return $this->render('spaceChooserCustom', [
    ...
    {
        if (!Yii::$app->user->isGuest) {
            return Membership::findByUserCommunity(Yii::$app->user->getIdentity(), $this->community->id)->all();
        }
    }
